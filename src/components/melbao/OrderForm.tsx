...
const OrderForm = () => {
  ...
  const fetchProducts = async () => {
    ...
    setOrderItems(data?.map(product => ({ product_id: product.id, quantity: 0 })) || []);
  };
      ...
      <div className="max-w-4xl mx-auto">
        <div className="max-w-3xl mb-10">
          ...
          <p className="text-muted-foreground mt-2">
            Fresh buns made to order. Each package contains 15 pieces for $12. Pickup Monday-Sunday, 5-7pm.
          </p>
        </div>
